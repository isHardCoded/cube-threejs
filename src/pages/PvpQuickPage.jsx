...
/** Instant queue: join any open lobby, or wait for the next one. */
export default function PvpQuickPage() {
  ...
  async function startSearch() {
    ...
    async function claimSeat() {
      const res = await matchmaking.quick()
      if (run.stale) {
  ...
  return (
    <div className="screen">
      <div className="screen__title">{t('pvp.hub.quick.name')}</div>
      ...
      <div className="screen__box">
        {error ? (
          ...
          <div className="pvp-search screen__card">
            ...
            <div className="pvp-search__meta">{t('pvp.quick.hint')}</div>
            <button
